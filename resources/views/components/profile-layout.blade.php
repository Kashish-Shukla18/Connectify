...
<div class="max-w-3xl mx-auto">
    ...
    <section class="grid grid-cols-12 p-2 my-5 lg:my-12 ">
        ...
        <div class="col-span-4 flex items-center">
            <x-avatar src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->name }}'s Avatar" sty class="w-20 h-20 lg:h-44 lg:w-44 m-auto shadow-2xl" />
        </div>
        ...
        <aside class="col-span-8 lg:max-w-2xl lg:mx-auto flex flex-col gap-5">
            ...
            <section class="grid grid-cols-12 gap-3">
                ...
                <div class="col-span-12 lg:col-span-6 grid grid-cols-2 gap-3 ">
                    ...
                    {{-- Send message button --}}
                    <a href="{{ route('profile.edit') }}" class="inline-flex justify-center font-bold items-center rounded-lg text-sm p-1.5 px-2 transition bg-gray-200 hover:bg-slate-100">
                        Edit profile
                    </a>
...
<!-- 
                ...
                <div class="col-span-12 lg:col-span-6 grid grid-cols-2 gap-3 ">
                    ...
                    <button wire:click="toggleFollow()" type="button" class=" inline-flex justify-center font-bold items-center  rounded-lg  text-sm p-1.5 px-2 transition  bg-gray-200 hover:bg-slate-100 ">
                        Following
                    </button>
                    @else


                    <button wire:click="toggleFollow()" type="button" class=" inline-flex justify-center font-bold items-center  rounded-lg  text-sm p-1.5 px-2 transition  bg-blue-500 text-white  ">
                        Follow
                    </button>
                    @endif

                    {{-- Send message button --}}
                    <button wire:click="message({{$user->id}})" type="button" class=" inline-flex justify-center font-bold items-center  rounded-lg  text-sm p-1.5 px-2 transition  bg-gray-200 hover:bg-slate-100 ">
                        Message
                    </button>
    ...
    <section class="border-t">
        <ul class="grid grid-cols-3 items-center gap-4 max-w-sm mx-auto pb-3 ">
            {{-- Posts --}}
            <li class="flex items-center gap-2 py-2 cursor-pointer  {{request()->routeIs('profile.home')?'border-t border-black':''}}">
                ...
                <a wire:navigate class="flex items-center gap-2 py-2 cursor-pointer" href="{{route('profile.home',$user->username)}}">
                    ...
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-border-all lg:w-5 lg:h-5" viewBox="0 0 16 16">
            ...
            <li class="flex items-center gap-2 py-2 cursor-pointer {{request()->routeIs('profile.saved')?'border-t border-black':''}}">
                ...
                <a wire:navigate class="flex items-center gap-2 py-2 cursor-pointer" href="{{route('profile.saved',$user->username)}}">
                    ...
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark lg:w-5 lg:h-5" viewBox="0 0 16 16">
