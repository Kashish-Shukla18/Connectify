...
<main class="lg:col-span-7">
            ...
            " class="swiper h-[500px] border bg-white">
                ...
                <ul x-cloak class="swiper-wrapper">
                    ...
                    <li class="swiper-slide">
                        ...
                        @break
                        @case('image')
                        <img src="{{$file->url}}" alt="" class="h-[500px] w-full block object-contain">
                        @break
                        @default
                        @endswitch
                    </li>
                ...
                <div class="swiper-button-prev absolute top-1/2 transform -translate-y-1/2 z-10 p-2">
                    <div class="bg-white/80 border p-1 rounded-full text-gray-900">
                ...
                <div class="swiper-button-next absolute right-0 top-1/2 transform -translate-y-1/2 z-10 p-2">
                    <div class="bg-white/80 border p-1 rounded-full text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.8" stroke="currentColor" class="w-4 h-4">
    ...
    <aside class="lg:col-span-5 h-full scrollbar-hide relative flex gap-4 flex-col overflow-hidden overflow-y-scroll">
        ...
        <header class="flex  items-center gap-3 border-b py-2  sticky  top-0 bg-white z-10 ">
            <x-avatar src="{{ asset('storage/' . $post->user->avatar) }}" alt="{{ $post->user->name }}'s Avatar" class="h-9 w-9" />
